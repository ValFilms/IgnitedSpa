...
@media (max-width: 768px) {
  .about-hero { padding: 110px 0 72px; }
...
@media (max-width: 480px) {
  ...
  /* Values */
  .about-val { padding: 28px 20px; }
  .av-num { font-size: 36px; }

  /* Reviews bar */
  .arb-num { font-size: 42px; }
  .arb-cta { width: 100%; justify-content: center; }
}
