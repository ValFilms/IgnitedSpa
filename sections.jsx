...
function Nav() {
  ...
  // On non-home pages, anchors must point back to index.html
  const isHome = typeof window !== 'undefined' && /\/(index\.html)?$/.test(window.location.pathname);
  const home = (hash) => (isHome ? hash : 'index.html' + hash);

  const navLinks = [
    { href: home('#offer'),    label: 'The offer' },
    { href: home('#work'),     label: 'Case studies' },
  ...
  return (
    <>
      ...
      {mobileOpen && <div className="mobile-nav-overlay" onClick={close} />}
      ...
      <div className={"mobile-nav " + (mobileOpen ? 'open' : '')} aria-hidden={!mobileOpen}>
        ...
        <a href="#contact" className="mobile-nav-cta" onClick={close}>
        ...
        <div className="cases reveal in">
          ...
          <div className="case case-big">
            ...
            <div className="case-body">
              ...
              <a href="case-study-glow-co.html" style={{display:'inline-flex',alignItems:'center',gap:'8px',marginTop:'20px',fontSize:'13px',fontWeight:'500',color:'var(--navy-2)'}}>
          ...
          <div className="case case-small">
            ...
            <a href="case-study-lumen.html" style={{display:'inline-flex',alignItems:'center',gap:'8px',fontSize:'13px',fontWeight:'500',color:'var(--navy-2)',marginTop:'12px'}}>
              Read the full case study →
            </a>
          </div>
          ...
          <div className="case case-small">
            ...
            <a href="case-study-maven.html" style={{display:'inline-flex',alignItems:'center',gap:'8px',fontSize:'13px',fontWeight:'500',color:'var(--navy-2)',marginTop:'12px'}}>
              Read the full case study →
            </a>
          </div>
        </div>
...
function Services() {
  const items = [
    { n: '01', icon: <Icon.target />, t: 'Paid Acquisition', d: 'Meta & Google ad systems built around your most profitable treatments and seasonal cadence.', href: 'service-paid-acquisition.html' },
    { n: '02', icon: <Icon.chart />, t: 'Funnels & Offers', d: 'Signature treatment offers, landing pages, and qualification flows tuned to high-ticket medspa buyers — not discount hunters.', href: 'service-funnels-offers.html' },
    { n: '03', icon: <Icon.bolt />, t: 'We Call & Qualify', d: 'Our trained reps call every inbound lead within minutes, qualify them, and take the deposit before they ever hit your calendar.', href: 'service-call-qualify.html' },
    { n: '04', icon: <Icon.spark />, t: 'We Book The Calendar', d: 'Qualified, deposit-paid patients land directly in your booking system. You walk in, treat, and the rest feels like magic.', href: 'service-book-calendar.html' },
  ];
  return (
    <section className="section services-section" id="services">
      <div className="container">
        ...
        <div className="services-grid reveal in">
          {items.map((it, i) => (
            <a href={it.href} className="service" key={i} style={{textDecoration:'none',color:'inherit'}}>
              <div>
              ...
              <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                <span className="service-num">— {it.n} / 04</span>
                <span style={{fontSize:'12px',color:'var(--navy-2)',display:'flex',alignItems:'center',gap:'4px',opacity:0.7}}>Learn more <Icon.arrow /></span>
              </div>
            </a>
          ))}
        </div>
...
function Footer() {
  const isHome = typeof window !== 'undefined' && /\/(index\.html)?$/.test(window.location.pathname);
  const h = (hash) => isHome ? hash : 'index.html' + hash;
  return (
      ...
      <div className="container">
        <div className="footer-grid">
          ...
          <div>
            <h4>Agency</h4>
            <ul>
              <li><a href={h('#work')}>Case studies</a></li>
              <li><a href={h('#services')}>Services</a></li>
              <li><a href="about.html">About us</a></li>
              <li><a href="why-ignited-spa.html">Why Ignited Spa</a></li>
          ...
          <div>
            <h4>Case Studies</h4>
            <ul>
              <li><a href="case-study-glow-co.html">Glow &amp; Co. · 8.4× ROAS</a></li>
              <li><a href="case-study-lumen.html">Lumen Studio · +317%</a></li>
              <li><a href="case-study-maven.html">Maven Skin Bar · $12K MRR</a></li>
            </ul>
          </div>
          <div>
            <h4>Services</h4>
            <ul>
              <li><a href="service-paid-acquisition.html">Paid Acquisition</a></li>
              <li><a href="service-funnels-offers.html">Funnels &amp; Offers</a></li>
              <li><a href="service-call-qualify.html">Call &amp; Qualify</a></li>
              <li><a href="service-book-calendar.html">Book the Calendar</a></li>
            </ul>
